...
| CNN-config | MSE, ACC*  | MSE, ACC** | Box plot model error summary | summary statistics |  prediction erroradsfdsafdfdsf | prediction residualsadsfsdfsdf | residuals misclassificaiton | residual class s.t. rounding error *** |
| - | - | - | - | - | - | - | - | - | 
